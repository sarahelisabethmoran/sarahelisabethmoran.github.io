...
Using Canva, I made an infographic showcasing what professions Graphic Design majors go into and what the most popular fields are. 
...
Using fusion tables, I portrayed the top 5 leading, or most successful design agencies in the New York City Area. The information and scores of these design agencies were taken from AAAwards and are based on clients, culture, authentic design and overall success that each agency has had. 
...
Tableau Chart showcasing hollywood movies by popularity in genre, gross income and audience score.  
<html>
...
## World Earthquakes
Utlizing Tableau, I showed World Earthquakes according to the amount of Earthquakes that have taken place in a location and their depth and magnitude shown on a map. I also included a line graphic showing the correlation to magnitude and year that shows that in the most recent years, the earthquakes on average have increased in magnitude. 
